...
// performance studies
//
#ifndef NEST_DETECTOR_G3_A_HH
#define NEST_DETECTOR_G3_A_HH

#include "VDetector.hh"

using namespace std;

class Detector_G3_A : public VDetector {
 public:
  Detector_G3_A() {
  ...
  ~Detector_G3_A() override = default;
  ...
  void Initialization() override {
    ...
    dtCntr = 505.123 * 2.30;  // center of detector for S1 corrections, in usec.
    dt_min = 0.01;     // minimum. Top of detector fiducial volume
    dt_max = 894.74 * 2.30;   // maximum. Bottom of detector fiducial volume
  ...
  double FitEF(double xPos_mm, double yPos_mm,
    ...
    return 300.;                           // Simple uniform field
  }
