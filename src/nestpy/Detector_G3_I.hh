...
// performance studies
//
#ifndef NEST_DETECTOR_G3_I_HH
#define NEST_DETECTOR_G3_I_HH

#include "VDetector.hh"

using namespace std;

class Detector_G3_I : public VDetector {
 public:
  Detector_G3_I() {
  ...
  ~Detector_G3_I() override = default;
  ...
  void Initialization() override {
    ...
    dtCntr = 505.123 * 1.82 * 1.210;  // center of detector for S1 corrections, in usec.
    dt_min = 0.01;     // minimum. Top of detector fiducial volume
    dt_max = 894.74 * 1.82 * 1.210;   // maximum. Bottom of detector fiducial volume
