...
// performance studies
//
#ifndef NEST_DETECTOR_G3_G_HH
#define NEST_DETECTOR_G3_G_HH

#include "VDetector.hh"

using namespace std;

class Detector_G3_G : public VDetector {
 public:
  Detector_G3_G() {
  ...
  ~Detector_G3_G() override = default;
  ...
  void Initialization() override {
    ...
    dtCntr = 505.123 * 1.82;  // center of detector for S1 corrections, in usec.
    dt_min = 0.01;     // minimum. Top of detector fiducial volume
    dt_max = 894.74 * 1.82;   // maximum. Bottom of detector fiducial volume
