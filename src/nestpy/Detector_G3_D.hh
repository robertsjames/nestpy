...
// performance studies
//
#ifndef NEST_DETECTOR_G3_D_HH
#define NEST_DETECTOR_G3_D_HH

#include "VDetector.hh"

using namespace std;

class Detector_G3_D : public VDetector {
 public:
  Detector_G3_D() {
  ...
  ~Detector_G3_D() override = default;
  ...
  void Initialization() override {
    ...
    dtCntr = 505.123 * 2.05;  // center of detector for S1 corrections, in usec.
    dt_min = 0.01;     // minimum. Top of detector fiducial volume
    dt_max = 894.74 * 2.05;   // maximum. Bottom of detector fiducial volume
