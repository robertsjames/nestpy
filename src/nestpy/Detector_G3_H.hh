...
// performance studies
//
#ifndef NEST_DETECTOR_G3_H_HH
#define NEST_DETECTOR_G3_H_HH

#include "VDetector.hh"

using namespace std;

class Detector_G3_H : public VDetector {
 public:
  Detector_G3_H() {
  ...
  ~Detector_G3_H() override = default;
  ...
  void Initialization() override {
    ...
    dtCntr = 505.123 * 1.82 * 1.066;  // center of detector for S1 corrections, in usec.
    dt_min = 0.01;     // minimum. Top of detector fiducial volume
    dt_max = 894.74 * 1.82 * 1.066;   // maximum. Bottom of detector fiducial volume

    radius = 1150.;  // millimeters (fiducial rad)
    radmax = 1150.;  // actual physical geo. limit
