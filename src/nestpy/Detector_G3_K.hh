...
// performance studies
//
#ifndef NEST_DETECTOR_G3_K_HH
#define NEST_DETECTOR_G3_K_HH

#include "VDetector.hh"

using namespace std;

class Detector_G3_K : public VDetector {
 public:
  Detector_G3_K() {
  ...
  ~Detector_G3_K() override = default;
  ...
  void Initialization() override {
    ...
    dtCntr = 505.123 * 1.45 * 1.066;  // center of detector for S1 corrections, in usec.
    dt_min = 0.01;     // minimum. Top of detector fiducial volume
    dt_max = 894.74 * 1.45 * 1.066;   // maximum. Bottom of detector fiducial volume

    radius = 880.;  // millimeters (fiducial rad)
    radmax = 880.;  // actual physical geo. limit
