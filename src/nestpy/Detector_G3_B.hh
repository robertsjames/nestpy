...
// performance studies
//
#ifndef NEST_DETECTOR_G3_B_HH
#define NEST_DETECTOR_G3_B_HH

#include "VDetector.hh"

using namespace std;

class Detector_G3_B : public VDetector {
 public:
  Detector_G3_B() {
  ...
  ~Detector_G3_B() override = default;
  ...
  void Initialization() override {
    ...
    dtCntr = 505.123 * 2.30 * 1.066;  // center of detector for S1 corrections, in usec.
    dt_min = 0.01;     // minimum. Top of detector fiducial volume
    dt_max = 894.74 * 2.30 * 1.066;   // maximum. Bottom of detector fiducial volume

    radius = 1485.;  // millimeters (fiducial rad)
    radmax = 1485.;  // actual physical geo. limit
  ...
  double FitEF(double xPos_mm, double yPos_mm,
    ...
    return 200.;                           // Simple uniform field
  }
