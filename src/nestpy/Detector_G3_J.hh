...
// performance studies
//
#ifndef NEST_DETECTOR_G3_J_HH
#define NEST_DETECTOR_G3_J_HH

#include "VDetector.hh"

using namespace std;

class Detector_G3_J : public VDetector {
 public:
  Detector_G3_J() {
  ...
  ~Detector_G3_J() override = default;
  ...
  void Initialization() override {
    ...
    dtCntr = 505.123 * 1.45;  // center of detector for S1 corrections, in usec.
    dt_min = 0.01;     // minimum. Top of detector fiducial volume
    dt_max = 894.74 * 1.45;   // maximum. Bottom of detector fiducial volume
